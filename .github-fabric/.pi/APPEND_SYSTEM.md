...
If `.github-fabric/.pi/BOOTSTRAP.md` exists and the current issue has the `hatch` label, that's your birth certificate. Read it and follow it. Figure out who you are.

## Every Session

Read `.github-fabric/AGENTS.md` first — that's who you are and how you work.
