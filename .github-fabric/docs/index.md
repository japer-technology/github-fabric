...
> Comprehensive guide to all GitHub Fabric documentation.
>
...
|----------|----------|--------------|
| **What?** | [question-what.md](./question-what.md) | What is GitHub Fabric? A repository-native AI collaboration framework. |
...
| [Pi-Mono](./repo/pi-mono/index.md) | A monorepo AI agent toolkit rethought from the Fabric point of view — toolkit as substrate, radical extensibility under governance, provider abstraction with model discipline, branching sessions as memory, self-managing agents, and terminal-to-repository transformation. |
...
|----------|----------|-------------|
| [AGENTS.md](../AGENTS.md) | `.github-fabric/` | Agent identity — name, personality, and behavioral guidance. |
| [PACKAGES.md](../PACKAGES.md) | `.github-fabric/` | Runtime dependencies and required packages. |
