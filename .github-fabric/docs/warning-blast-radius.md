...
> available to the `github-fabric` (GMI) agent running as a GitHub Actions
...
- ✅ **Clone any org repository** (verified: `github-fabric`, `aws-lambda-nodejs-catch-all`)
...
japer-technology/github-fabric
