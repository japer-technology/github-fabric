...
- Any conduct that would violate the [Four Laws of AI](.github-fabric/docs/the-four-laws-of-ai.md).

---

## Alignment with the Four Laws

This project defines [Four Laws of AI](.github-fabric/docs/the-four-laws-of-ai.md) that govern the system's behavior. Contributors — human and automated alike — are expected to uphold these principles:
...
This Code of Conduct is adapted from the [Contributor Covenant](https://www.contributor-covenant.org/), version 2.1, with additions specific to this project's [Four Laws of AI](.github-fabric/docs/the-four-laws-of-ai.md) and [Before You Begin](.github-fabric/docs/final-warning.md) guide.
